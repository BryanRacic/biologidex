...
Implements the Walker-Buchheim O(n) algorithm for aesthetically pleasing
rectangular/vertical hierarchical layouts.

For radial layouts, see eades_radial.py which uses angular wedge allocation.
